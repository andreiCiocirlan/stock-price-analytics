package com.example.stockprices.client;


import com.example.stockprices.model.annual.FinancialData;
...
import static com.example.stockprices.util.Constants.BASE_URL;
...
//    }
    ...
    public ResponseEntity<FinancialData> financialDataFor(String ticker) {
        try {
            return restTemplate.getForEntity(BASE_URL + "/stock/metric?symbol={ticker}&metric=all&token={apiKey}",
