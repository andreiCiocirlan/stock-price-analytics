...
public class IntraDayPricesController {
    ...
    public void yahooPricesImport() {
        ...
        if (dailyImportedPrices != null && !dailyImportedPrices.isEmpty()) {
            ...
            logTime(() -> stockService.updateStocksOHLCFromDailyImportedPrices(dailyImportedPrices), "updated stocks OHLC, last_updated, and performance from daily imported prices ");
