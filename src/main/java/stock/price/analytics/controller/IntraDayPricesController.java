...
public class IntraDayPricesController {
    ...
    public void yahooPricesImport() {
        ...
        if (!dailyImportedPrices.isEmpty()) {
            ...
            highLowForPeriodService.saveOrUpdateHighLow_4w_52w(dailyImportedPrices.stream().map(DailyPriceOHLC::getTicker).toList(), tradingDateImported(dailyImportedPrices));
