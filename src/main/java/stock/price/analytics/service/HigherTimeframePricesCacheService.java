...
public class HigherTimeframePricesCacheService {
    ...
    public void initHigherTimeframePricesCache() {
        ...
        higherTimeframePricesCache.addWeeklyPrices(pricesRepository.findPreviousThreeWeeklyPricesForTickers(tickers));
        higherTimeframePricesCache.addMonthlyPrices(pricesRepository.findPreviousThreeMonthlyPricesForTickers(tickers));
